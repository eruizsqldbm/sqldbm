...
CampaignId  string NOT NULL REFERENCES CRM.Campaign(CampaignId) NOT ENFORCED OPTIONS(description = 'Unique identifier for each campaign, serving as the primary key.')
)
