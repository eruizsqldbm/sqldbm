...
CREATE TABLE CRM.PRICEBOOK_ENTRY (
  ...
  CONSTRAINT FK_84 FOREIGN KEY (PRICEBOOK_ID) REFERENCES CRM.PRICEBOOK (PRICEBOOK_ID),
  CONSTRAINT FK_85 FOREIGN KEY (PRODUCT_ID) REFERENCES CRM.PRODUCT (PRODUCT_ID)
)
