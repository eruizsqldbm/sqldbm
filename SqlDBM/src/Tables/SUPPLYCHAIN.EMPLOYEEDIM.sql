...
CREATE TABLE IF NOT EXISTS SUPPLYCHAIN.EMPLOYEEDIM
(
 ...
 FNAME           varchar(100) COMMENT 'The ''FirstName'' column contains data related to ''firstname''. This column holds name-related data.',
