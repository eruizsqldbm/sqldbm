...
PurchaseOrderId     numeric REFERENCES POS.PurchaseOrder(PurchaseOrderId) NOT ENFORCED OPTIONS(description = 'The purchase order to which the item belongs, linked to the PurchaseOrder table.'),
