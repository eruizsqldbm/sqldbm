...
CREATE TABLE CRM.CONTRACT (
  ...
  CONSTRAINT FK_87 FOREIGN KEY (LOYALTYPROGRAMKEY) REFERENCES SUPPLYCHAIN.CUSTOMERLOYALTYPROGRAMDIM (LOYALTYPROGRAMKEY),
  ...
  CONSTRAINT FK_86 FOREIGN KEY (ACCOUNT_ID) REFERENCES CRM.ACCOUNT (ACCOUNT_ID)
)
