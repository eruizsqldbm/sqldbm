-- ************************************** SUPPLYCHAIN.WAREHOUSE_1
CREATE TABLE SUPPLYCHAIN.WAREHOUSE_1 (
...
COMMENT 'Stores information about warehouse facilities including their locations, managers, and storage capacity.';