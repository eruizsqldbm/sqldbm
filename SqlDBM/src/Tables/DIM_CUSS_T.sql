-- ************************************** DIM_CUSS_T
CREATE TABLE DIM_CUSS_T (
  CUSS_KEY bigint NOT NULL COMMENT 'Surrogate primary key',
  CUSS_ID_BK varchar(50) NOT NULL COMMENT 'Business key: natural customer identifier from source system',
  CUSS_NAME varchar(255) NOT NULL COMMENT 'Customer full name',
