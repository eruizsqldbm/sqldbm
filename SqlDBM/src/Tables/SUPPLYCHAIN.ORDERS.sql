...
CREATE TABLE SUPPLYCHAIN.ORDERS (
  ...
  CONSTRAINT FK_135 FOREIGN KEY (SHIPMENTID) REFERENCES SUPPLYCHAIN.SHIPMENT (SHIPMENTID),
  CONSTRAINT FK_19 FOREIGN KEY (SHIPMENTID) REFERENCES SUPPLYCHAIN.SHIPMENT (SHIPMENTID),
  CONSTRAINT FK_6 FOREIGN KEY (CUSTOMERID) REFERENCES SUPPLYCHAIN.CUSTOMER_2 (CUSTOMERID),
  CONSTRAINT FK_134 FOREIGN KEY (CUSTOMER_ID) REFERENCES POS.CUSTOMER (CUSTOMER_ID)
);