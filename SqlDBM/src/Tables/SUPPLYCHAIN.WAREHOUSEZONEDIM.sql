...
COMMENT = 'Dimension table that stores information about warehouse zones, including their names and functional roles within each warehouse. Used to support supply chain analytics by providing zone-level context for inventory and logistics operations.';
