...
CREATE TABLE SUPPLYCHAIN.WAREHOUSEZONEDIM (
  ...
  CONSTRAINT FK_106 FOREIGN KEY (ZONEKEY) REFERENCES SUPPLYCHAIN.WAREHOUSEZONEDIM (ZONEKEY)
)
COMMENT 'Dimension table for warehouse zones, providing detailed information about zones within warehouses including zone names and functions.';