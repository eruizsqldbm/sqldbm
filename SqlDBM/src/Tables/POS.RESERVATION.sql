...
CREATE TABLE POS.RESERVATION (
  ...
  CONSTRAINT FK_118 FOREIGN KEY (LOCATION_ID) REFERENCES POS.LOCATION (LOCATION_ID),
  ...
  CONSTRAINT FK_117 FOREIGN KEY (CUSTOMER_ID) REFERENCES POS.CUSTOMER (CUSTOMER_ID)
)
