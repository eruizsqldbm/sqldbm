...
CREATE TABLE CRM.CAMPAIGN_MEMBER_T (
  ...
  CONSTRAINT CAMPAIGN_ID FOREIGN KEY (CAMPAIGN_ID) REFERENCES CRM.CAMPAIGN_T (CAMPAIGN_ID),
  CONSTRAINT LEAD_ID FOREIGN KEY (LEAD_ID) REFERENCES CRM.LEAD_T (LEAD_ID)
)
