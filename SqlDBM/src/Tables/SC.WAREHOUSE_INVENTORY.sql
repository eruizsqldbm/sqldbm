...
CREATE TABLE SC.WAREHOUSE_INVENTORY (
  ...
  CONSTRAINT FK_114 FOREIGN KEY (MATERIAL_ID) REFERENCES SC.MATERIAL (MATERIAL_ID),
  CONSTRAINT MATERIAL_ID FOREIGN KEY (MATERIAL_ID) REFERENCES SC.MATERIAL (MATERIAL_ID),
  CONSTRAINT FK_113 FOREIGN KEY (WAREHOUSE_ID) REFERENCES SC.WAREHOUSE (WAREHOUSE_ID),
